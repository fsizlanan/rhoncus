...
<head>
  ...
  <!-- End layout styles -->
  <link rel="shortcut icon" href="{{asset('assets/images/logom.jpg')}}" />
</head>
    ...
    <nav class="sidebar sidebar-offcanvas" id="sidebar">
      <!--
        <div class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
          <a class="sidebar-brand brand-logo" href="{{Route('admin.index')}}"><img src="../../assets/images/faces/face2.jpg" alt="logo" /></a>
        </div>
-->
      <ul class="nav">
          ...
          <div class="profile-desc">
            <div class="profile-pic">
              <div class="count-indicator">
                <img class="img-xs rounded-circle " src="../../assets/images/logom.jpg" alt="">
                <span class="count bg-success"></span>
              </div>
              <div class="profile-name">
                <h5 class="mb-0 font-weight-normal">Rhoncus Çiğköfte </h5>
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="navbar p-0 fixed-top d-flex flex-row">
        <div class="navbar-brand-wrapper d-flex d-lg-none align-items-center justify-content-center">
          <a class="navbar-brand brand-logo-mini" href="{{Route('admin.index')}}"><img src="../../assets/images/logo-mini.svg" alt="logo" /></a>
        </div>
            ...
            <li class="nav-item dropdown">
              <a class="nav-link" id="profileDropdown" href="#" data-toggle="dropdown">
                <div class="navbar-profile">
                  <img class="img-xs rounded-circle" src="../../assets/images/logom.jpg" alt="">
                  <p class="mb-0 d-none d-sm-block navbar-profile-name">Rhoncus Çiğköfte</p>
              ...
              <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="profileDropdown">
                ...
                <a class="dropdown-item preview-item">
                  ...
                  <div class="preview-item-content">
                    <p class="preview-subject mb-1"><button class="btn btn-primary btn-success">Ayarlar</button> </p>
                  </div>
                </a>
                <div class="dropdown-divider"></div>
                <a class="dropdown-item preview-item">
