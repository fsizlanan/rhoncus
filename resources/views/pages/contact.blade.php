    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
             ...
             -->
                <iframe class="map-responsive" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3124.216769549554!2d27.209480515629526!3d38.45955658023759!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x14b97d8db57390f1%3A0xb888b4d3b2a36eb0!2zUmhvbmN1cyDDp2nEn2vDtmZ0ZQ!5e0!3m2!1str!2str!4v1618428505471!5m2!1str!2str" 
                width="100%" height="150%" style="border:0; position :relative; padding-bottom :300px;" allowfullscreen="" loading="lazy"></iframe>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-9">
                <form action="" method="POST">
                    @csrf
                    <div class="left">
                        <input type="text" placeholder="Ad & Soyad" name="MassageName" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Ad & Soyad'" required>
                        <input type="email" placeholder="E-mail Adresi" name="MessageEmail" onfocus="this.placeholder = ''" onblur="this.placeholder = 'E-mail'" required>
                        <input type="text" placeholder="Konu Başlığı" name="MessageSubject" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Mesaj Başlığı'" required>
                    </div>
                    <div class="right">
                        <textarea name="message" cols="20" rows="7" placeholder="Detaylı Mesaj" id="MessajeText" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Mesajınız'" required></textarea>
                    </div>
